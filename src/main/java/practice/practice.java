...
//		WebDriverWait wait = new WebDriverWait(driver,30);
	...
	//	driver.findElement(By.id("SearchEmail")).sendKeys("Maheshtest@gmail.com");
...
//			emaillist.add(email);
			...
			if(email.equalsIgnoreCase("TestUserInternal1@test.com")) {
		...
		WebElement ele = driver.findElement(By.id("//*[@id='customermodel-Delete-delete-confirmation']/div/div/form/div/div[2]/button"));
